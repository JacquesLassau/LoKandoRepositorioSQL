...
BEGIN
	BEGIN TRAN 
	IF NOT EXISTS (Select CLIDCLLOK From DB_LOKANDO..TBCLIENTLOK With(nolock) Where CLIDCLLOK = @CLIDCLLOK And CLSITLOK <> 'I')
	BEGIN			
	...
	ELSE
	BEGIN
		Select * from  DB_LOKANDO..TBCLIENTLOK With(nolock) Where CLIDCLLOK = @CLIDCLLOK;
