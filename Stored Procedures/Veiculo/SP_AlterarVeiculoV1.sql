...
BEGIN  
 ...
 ELSE  
 BEGIN  
  Update DB_LOKANDO..TBVEICLOK Set VCCODLCDLOK = @VCCODLCDLOK, VCTPLOK = @VCTPLOK, VCMARCALOK = @VCMARCALOK, VCMODELOK = @VCMODELOK, VCCOMBLOK = @VCCOMBLOK, VCCORLOK = @VCCORLOK, VCANOLOK = @VCANOLOK, VCVLRDIA = @VCVLRDIA, VCSITLOK = @VCSITLOK, VCHRREGLOK = GETDATE() Where VCPLACALOK = @VCPLACALOK;  
